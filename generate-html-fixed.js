    ...
    <div class="container">
        ...
        <nav class="nav">
            <ul>
                ...
                <li><a href="GUIA-CONTROLLER-BOAS-PRATICAS.html">🎮 Guia Controllers</a></li>
                <li><a href="SWAGGER-DOCUMENTACAO.html">📖 Swagger</a></li>
                <li><a href="ROADMAP-PROXIMOS-PASSOS.html">🗺️ Roadmap</a></li>
                <li><a href="TUTORIAL-GITHUB-PAGES.html">📚 Tutorial</a></li>
            </ul>
        </nav>
...
async function createIndexPage(outputDir) {
    ...
    <ul>
        <li><a href="GUIA-CONTROLLER-BOAS-PRATICAS.html"><strong>Guia de Boas Práticas - Controllers</strong></a> - Padrões e anotações para desenvolvimento REST</li>
    ...
    <ul>
        ...
        <li><a href="TUTORIAL-GITHUB-PAGES.html"><strong>Tutorial GitHub Pages</strong></a> - Como replicar esta documentação</li>
    </ul>
    ...
    <blockquote>
        ...
        depois veja o <a href="GUIA-CONTROLLER-BOAS-PRATICAS.html">Guia de Controllers</a> para padrões de desenvolvimento.
    </blockquote>
