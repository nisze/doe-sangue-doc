...
async function createIndexPage(outputDir) {
    ...
    <h3>� Guias Fundamentais</h3>
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 20px; border-radius: 10px; margin: 20px 0; color: white; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
        <h4 style="color: white; margin-bottom: 15px; font-size: 1.3em;">⚡ Guia Repository Pattern & Spring Data JPA</h4>
        <p style="margin-bottom: 15px; line-height: 1.6;">
            <strong>Guia completo e fundamental</strong> sobre Repository Pattern, Spring Data JPA, Query Methods e otimização com índices de banco de dados. 
            <em>Essencial para entender a base da persistência no projeto!</em>
        </p>
        <a href="GUIA-REPOSITORY-PATTERN.html" style="display: inline-block; background: rgba(255,255,255,0.2); color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; transition: all 0.3s; border: 1px solid rgba(255,255,255,0.3);">
            📊 Acessar Guia Repository Pattern →
        </a>
        <div style="margin-top: 10px; font-size: 0.9em; opacity: 0.9;">
            <strong>🎯 Inclui:</strong> Conceitos fundamentais • Implementação prática • Query Methods • Índices para performance • Testes • 60+ links oficiais
        </div>
    </div>
